...
int main() {
    ...
    // ------------------------------------------------------------------
    float vertices[] = {
        -0.41f,  0.92f, 0.0f, // C 0
        -0.08f,  0.58f, 0.0f, // D 1
        -0.75f,  0.58f, 0.0f, // E 2
        -0.4f,   0.24f, 0.0f, // F 3
        -0.4f,   0.58f, 0.0f, // G 4
        -0.08f,  0.24f, 0.0f, // H 5
        -0.4f,  -0.09f, 0.0f, // I 6
        -0.73f, -0.09f, 0.0f, // J 7
        0.2f,   -0.09f, 0.0f, // L 8
        -0.27f, -0.56f, 0.0f, // K 9
        0.67f,  -0.56f, 0.0f, // M 10
        -0.61f, -0.9f, 0.0f, // O 11
        -0.26f, -0.9f, 0.0f, // N 12
        0.47f,  -0.65f, 0.0f, // P 13
        0.38f,  -0.98f, 0.0f, // Q 14
        0.14f,  -0.56f, 0.0f, // R 15
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // draw first 5 triangles with orange shader
        glUseProgram(shaderProgramOrange);
        glBindVertexArray(VAO);
        glDrawElements(GL_TRIANGLES, 15, GL_UNSIGNED_INT, 0);

        // draw last 4 triangles with yellow shader
...
"void main()\n"
"{\n"
"   FragColor = vec4(0.996f, 0.8f, 0.0f, 1.0f);\n" // Amarillo
"}\n\0";
...
"void main()\n"
"{\n"
"   FragColor = vec4(0.196f, 0.6f, 0.996f, 1.0f);\n" // Azul
"}\n\0";
...
"void main()\n"
"{\n"
"   FragColor = vec4(1.0f, 0.596f, 0.196f, 1.0f);\n" // Naranja
"}\n\0";

// Add more fragment shader sources as needed
...
int main() {
    ...
    // ------------------------------------
    unsigned int vertexShader = glCreateShader(GL_VERTEX_SHADER);
    unsigned int fragmentShaders[9];
    ...
    const char* fragmentShaderSources[] = {
        ...
        fragmentShader4Source,
        fragmentShader5Source,
        fragmentShader6Source,
        fragmentShader7Source,
        fragmentShader8Source,
        fragmentShader9Source
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // dibujar triángulos con diferentes sombreadores
        for (int i = 0; i < 9; ++i) {
