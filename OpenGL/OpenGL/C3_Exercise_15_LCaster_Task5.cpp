 ...
 while (!glfwWindowShouldClose(window))
 {
    ...
    */	
    ...
    // Calcular fluctuaciones
     float fluctuation = sin(glfwGetTime() * fluctuationFrequency) * 0.1f;


     lightingShader.setVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
     lightingShader.setVec3("dirLight.ambient", baseAmbient + fluctuation, baseAmbient * 0.5f + fluctuation, baseAmbient * 0.2f + fluctuation);
     lightingShader.setVec3("dirLight.diffuse", baseDiffuse + fluctuation, baseDiffuse * 0.5f + fluctuation, baseDiffuse * 0.2f + fluctuation);
     lightingShader.setVec3("dirLight.specular", baseSpecular + fluctuation, baseSpecular * 0.5f + fluctuation, baseSpecular * 0.2f + fluctuation);
     // point light 1
     ...
     lightingShader.setVec3("pointLights[1].ambient", pointLightColors[1].x * 0.2, pointLightColors[1].y * 0.2, pointLightColors[1].z * 0.2);
     ...
     lightingShader.setVec3("pointLights[2].ambient", pointLightColors[2].x * 0.2, pointLightColors[2].y * 0.2, pointLightColors[2].z * 0.2);
     ...
     lightingShader.setVec3("pointLights[3].ambient", pointLightColors[3].x * 0.2, pointLightColors[3].y * 0.2, pointLightColors[3].z * 0.2);
     ...
     lightingShader.setVec3("spotLight.direction", camera.Position.x, camera.Position.y, camera.Position.z);
     ...
     /*pointLightPositions[1].x = 12.5f * sin(currentFrame);
     pointLightPositions[1].y = 9.5f * cos(currentFrame);
     pointLightPositions[1].z = -20.5f * sin(currentFrame);*/
